...
public class Assignment10 {
	...
	@Test(description = "verify creation and Deletion Of Cource",priority = 1)
	@Parameters("Browser")
...
//		List<WebElement> coursesnow = driver.findElements(By.xpath("//tr"));
//		 int numberOfCourcesNow = coursesnow.size();
//		 Reporter.log("Courses avaialble are::"+numberOfCourcesNow, true);
//		 Assert.assertEquals(coursesnow, courses,"Number of courses should remain same as before adding the new course");
//		
